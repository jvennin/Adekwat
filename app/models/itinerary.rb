...
class Itinerary < ApplicationRecord
  ...
  def search_api_google
    ...
    url = "https://maps.googleapis.com/maps/api/directions/json?origin=#{start_location.lat}, #{start_location.lng}&destination=#{end_location.lat}, #{end_location.lng}&mode=transit&alternatives=true&key=#{ENV["API_KEY_GOOGLE"]}"
